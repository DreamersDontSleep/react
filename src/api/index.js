...
export const reqLogin = (username, password) => request(BASE + '/auth/signin/local?signName=' + username + '&passwd=' + password, {}, 'POST')
...
// 搜索商品分页列表 (根据商品描述)
/*export const reqSearchProducts2 = ({pageNum, pageSize, searchName}) => request(BASE + '/manage/product/search', {
  pageNum,
  pageSize,
...
// 修改商品
// export const reqUpdateProduct = (product) => request(BASE + '/manage/product/update', product, 'POST')
